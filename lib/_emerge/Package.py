...
class Package(Task):
	...
	class _iuse(object):
		...
		__slots__ = ("__weakref__", "_iuse_implicit_match", "_pkg",
			"all", "enabled", "disabled", "tokens")
		...
		def is_valid_flag(self, flags):
			...
			for flag in flags:
				if not flag in self.all and not self._iuse_implicit_match(flag):
					return False
			return True
